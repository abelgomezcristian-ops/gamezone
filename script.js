...
{id:27,name:"Silent Hill 2",category:"destacado",price:2500,genre:"SurvivalHorror",top:false,image:"img/silent-hill-2.jpg"},
          ...
          return `
            <div class="cart-item">
              ...
              <div class="cart-item-info">
                <h3>${item.name}</h3>
                <p>${formatPrice(price)} x ${item.quantity}</p>
              </div>
